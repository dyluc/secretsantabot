# secretsantabot
A Python email bot to generate Secret Santa matches.

Before running, modify the files inside /res:

+ **emails.txt** should contain a list of names and matching email addresses.
